        ...
        while True:
            ...
            if on_menus[0] or on_menus[1] or on_menus[2]:
                ...
                if (game_modes[2]):
                    ...
                    #IF to add predictions every N frame, right now deactivated, every single frame we ask for estimated_valuess
                    if (self.prediction_cycle >= 0): 
                        ...
                        # check Vel_Y estimated_valuess, if lower means lander should go up
                        if (self.lander.velocity.y > nn_prediction[1]):
                            self.controller.set_up(True)
                        
                        # check Vel_X estimated_valuess, if estimated_valuess is higher than current go right, if lower go left
